...
const SelfSchedules = (props) => {
    ...
    const viewSchedule = async (date) => {
        ...
        try {
            const {data} = await  axios.get(route('schedules.view_self_schedules'), {
                headers: {
        ...
        <Layout>
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-2">
                ...
                <Panel header={`Thống kê lịch làm tuần này (${startOfWeek} - ${endOfWeek}) :`}
                       ...
                       bordered shaded>
                    {self_schedules ?
                        (<div key={self_schedules.id}>
                            <div className="flex flex-col gap-3">
                                <List className="col-span-3" >
                                    {self_schedules.schedules.map((schedule_user) => {
