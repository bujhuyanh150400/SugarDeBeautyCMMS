...
const Add = props => {
    const {users, workflows, test_questions, errors, training_route} = props;
    const initData = {
        title: training_route.title,
        description: training_route.description,
        time: training_route.time,
        users: _.map(training_route.users, (user, id) => {
            return user.id
        }),
        workflows: _.map(training_route.workflows, (user, id) => {
            return user.id
        }),
        test_questions: _.map(training_route.test_questions, (user, id) => {
            return user.id
        }),
    }
